...
fn = 'D:\libinbin\Desktop\matlab\layer_denoize\data\IRSNO1B_20210509_01_026.nc';
mdata = load_L1B(fn);
...
for i=1:size(data,2)
    data_1(:,i)=data(ceil(mdata_WGS84.Surface_Bin(i))-99:ceil(mdata_WGS84.Surface_Bin(i))+500,i);%高程校正
end
data_coh_overlay=overlay(data_1,2);        %相干叠加
%data_coh_overlay=overlay(data_coh_overlay.',2);        %相干叠加
%data_coh_overlay=data_coh_overlay.';        %相干叠加
%data_1=zeros(101,1172);
